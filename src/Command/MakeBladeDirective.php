...
#[AsCommand(
    name:"blade:make:directive",
    description: 'Create Directive',
)]
class MakeBladeDirective extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (!preg_match('/^[a-z0-9_]+$/', $name)) {
            $io->error('The directive name contains invalid characters. Use only lowercase letters, numbers, and underscores.');
